...
# ══ CONFIGURATIE ══
# Het token wordt bij voorkeur gelezen uit de Windows-omgevingsvariabele
# HVW_GITHUB_TOKEN (één keer instellen op je PC, werkt daarna voor elke
# toekomstige versie van dit script — zie README voor de instructies).
# Vind hij die niet, dan valt hij terug op de waarde hieronder.
GITHUB_TOKEN = os.environ.get("HVW_GITHUB_TOKEN", "JOUW_TOKEN_HIER")
...
def main():
    ...
    if GITHUB_TOKEN == "JOUW_TOKEN_HIER":
        print("\n⚠️  Geen GitHub token gevonden!")
        print("   Optie A (eenmalig, werkt voor elke toekomstige versie):")
        print("     Stel de omgevingsvariabele HVW_GITHUB_TOKEN in op je PC.")
        print("     Zie README.md voor de exacte stappen.")
        print("   Optie B (enkel voor dit bestand):")
        print("     Regel 20: GITHUB_TOKEN = os.environ.get(\"HVW_GITHUB_TOKEN\", \"JOUW_TOKEN_HIER\")")
        print("     Vervang \"JOUW_TOKEN_HIER\" door je eigen token.")
    ...
    bestanden = [
        ...
        ("assets/functionsheets.js","assets/functionsheets.js"),
        ("assets/dymo-print.js",    "assets/dymo-print.js"),
        ("assets/dymo.connect.framework.js", "assets/dymo.connect.framework.js"),
        ("assets/snelle-etiketten.js","assets/snelle-etiketten.js"),
        ("assets/portie-etiketten.js","assets/portie-etiketten.js"),
        ("assets/weekmap.js",       "assets/weekmap.js"),
        ("assets/kiosk.js",         "assets/kiosk.js"),
        ("assets/bakker.js",        "assets/bakker.js"),
        ("assets/bestelling_pdf.js","assets/bestelling_pdf.js"),
